...
{
	public class DeagleProjectile : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("DeagleProjectile");
		...
		{
			int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 32, default(Color), 0.9f);
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int num629 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 32, 0f, 0f, 491, default(Color), 2f);
			...
			{
				int num631 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 32, 0f, 0f, 491, default(Color), 3f);
                Main.dust[num631].noGravity = true;
				Main.dust[num631].velocity *= 5f;
                num631 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 32, 0f, 0f, 491, default(Color), 2f);
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				for (int num221 = 0; num221 < num220; num221++)
				{
                    ...
                    Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value17.X, value17.Y, 695, projectile.damage, 1f, projectile.owner, 0f, Main.rand.Next(-45, 1));
                }
			}
		}
        }
