...
{
	public class AnnihilationCannon : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Annihilation Cannon");
			Tooltip.SetDefault("Fires a deadly laser beam! Can consume bullets, rockets, arrows and stakes all at once!");
		}
