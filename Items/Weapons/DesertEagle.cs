...
namespace ClamMod.Items.Weapons
{
	public class DesertEagle : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Rise the Sand Phoenix");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType("DeagleProjectile"); //idk why but all the guns in the vanilla source have this
			item.shootSpeed = 30f;
		}
		...
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(ItemID.GoldBird, 1);
