...
{
	public class MercyTorch : ModItem
	{
		public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Mercy Torch");
            Tooltip.SetDefault("Finally some peace and quiet!");
		}
		...
		public override void SetDefaults()
		{
			...
			item.createTile = mod.TileType("MercyTorch");
			item.flame = true;
			item.value = 50;
		}
		...
		public override void HoldItem(Player player)
		{
			if (Main.rand.Next(player.itemAnimation > 0 ? 40 : 80) == 0)
			{
                ...
                player.GetModPlayer<MyPlayer>(mod).Calming = true;
            }
