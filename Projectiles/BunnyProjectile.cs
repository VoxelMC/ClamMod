	...
	public class BunnyProjectile : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			else
			{
				...
				Main.PlaySound(SoundID.Item79, projectile.position);
			}
			return false;
		}
		...
		public override void Kill(int timeLeft)
		{
			for (int k = 0; k < 5; k++)
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 177, projectile.oldVelocity.X * 0.5f, projectile.oldVelocity.Y * 0.5f);
			}
