...
namespace Logicalty.Projectiles
{
    public class ThunderBurstProjectile : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                {
                    Vector2 value18 = new Vector2(Main.rand.Next(-100, 101), Main.rand.Next(-100, 101));
                    value18.Normalize();
                    value18 *= Main.rand.Next(10, 201) * 0.01f;
                    target.AddBuff(144, 100);
                    Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value18.X, value18.Y, mod.ProjectileType("LightningBolt"), projectile.damage, 1f, projectile.owner, 0f, Main.rand.Next(-45, 1));
